...
LogIn System.
 ...
 QR Code Generator (For Fun)
This is a simple Python project that generates QR codes from any text or URL you provide.  
⚠️ **Note:** The QR codes generated by this script are **dummy/fun codes** and may **not be recognized by all QR code scanners**. Use for experimentation or demonstration purposes only.
It can,
- Generate QR codes from text or URLs  
- Save QR codes as PNG images  
- Simple and easy-to-use console interface
- Install the pip install qrcode[pip]
  AUTHORED BY RunanuJr
